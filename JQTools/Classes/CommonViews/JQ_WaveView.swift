...
class JQ_WaveView: UIView {
    ...
    // 真实波浪颜色
    var realWaveColor: UIColor = UIColor(red: 55, green: 153, blue: 249, alpha: 1)
    // 阴影波浪颜色
    var maskWaveColor: UIColor = UIColor(red: 55, green: 153, blue: 249, alpha: 0.3)
    // 波浪位置（默认是在下方）
