...
@property(nonatomic,copy)VPIImageCropperClouse completeClouse;
@property(nonatomic,copy)VPIImageCancelClouse cancelClouse;
...
-(void)imageCropperHandler:(VPIImageCropperClouse)complete CancelClouse:(VPIImageCancelClouse)cancel{
    self.completeClouse = complete;
    self.cancelClouse = cancel;
}
...
- (void)confirm:(id)sender {
    ...
    if (self.completeClouse != nil) {
        self.completeClouse(self, [self getSubImage]);
    }
}
